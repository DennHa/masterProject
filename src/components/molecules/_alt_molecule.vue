    ...
    methods: {
        ...
        enter: function(el, done) {
            ...
            Velocity(el, {
             ...
             rotateX(){
                vm.currentRotateX = !firstSel.rotationxfinal ? 0 : firstSel.rotationxfinal
                return vm.currentRotateX + "deg"

              },
              rotateY(){
                vm.currentRotateY = !firstSel.rotationyfinal ? 0 : firstSel.rotationyfinal
                return vm.currentRotateY + "deg"

              },
              rotateZ(){
                 vm.currentRotateZ = !firstSel.rotationzfinal ? 0 : firstSel.rotationzfinal
                 return vm.currentRotateZ + "deg"
              },
              width(){
              ...
              opacity(){
                vm.currentOpacity = !firstSel.opacityfinal ? 100 : firstSel.opacityfinal
                return vm.currentOpacity / 100
            ...
            // if second rotation
            if (secondSel.rotationyfinal) {
              Velocity(el, {
                rotateX(){
                  vm.currentRotateX = +vm.currentRotateX + +secondSel.rotationxfinal + -secondSel.rotationxstart
                  return vm.currentRotateX

                },
                rotateY(){
                  vm.currentRotateY = +vm.currentRotateY + +secondSel.rotationyfinal + -secondSel.rotationystart
                  return vm.currentRotateY

                },
                rotateZ(){
                  vm.currentRotateZ = +vm.currentRotateZ + +secondSel.rotationzfinal + -secondSel.rotationzstart
                  return vm.currentRotateZ
                }
              }, {
                  delay: "2000",
                easing: secondSel.spacing,
                duration: secondSel.timing,
                  queue: this.isQueueSecond,
                  complete: function() {
                      done()
                      if (!vm.stop) vm.nukleolus = false
                  }
            ...
            // if second Size
             else if (secondSel.widthfinal) {
              Velocity(el, {
                width(){
                    vm.currentWidth = +vm.currentWidth  +  +secondSel.widthfinal + -secondSel.widthstart
                    return vm.currentWidth + "%"

                },
                height(){
                  vm.currentHeight = +vm.currentHeight + +secondSel.heightfinal + -secondSel.heightstart
                  return vm.currentHeight + "%"
                }
              }, {
                  delay: "2000",
            ...
            //if second opacity
            if (secondSel.opacityfinal) {
              Velocity(el, {
                opacity(){
                  vm.currentOpacity = +vm.currentOpacity +  +secondSel.opacityfinal + -secondSel.opacityfinal
                return vm.currentOpacity / 100
                }
              }, {
                  delay: "2000",
                  eaeasing: secondSel.spacing,
                  duration: secondSel.timing,
                  queue: this.isQueueSecond,
                  complete: function() {
                      done()
